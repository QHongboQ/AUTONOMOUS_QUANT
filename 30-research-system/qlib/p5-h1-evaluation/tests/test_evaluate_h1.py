...
class H1ThinAdapterTests(unittest.TestCase):
    ...
    def test_attempt_001_is_never_finally_classified(self) -> None:
        ...
        with self.assertRaisesRegex(ValueError, "attempt-001/002/003/004"):
            h1.classify_h1("ATTEMPT_004_FINAL_CLEAN", 0.01, 0.02)

    def test_undefined_primary_metric_is_inconclusive(self) -> None:
        self.assertEqual(
            h1.classify_h1("ATTEMPT_005_FINAL_END_TO_END", np.nan, 0.02),
            "INCONCLUSIVE",
        )
