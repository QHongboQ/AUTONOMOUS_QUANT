...
>
> Current Next: **P0 — Upstream Fit Audit**
>
...
CURRENT_NEXT = P0_UPSTREAM_FIT_AUDIT
P0_UPSTREAM_BATCH_DEPLOYMENT = CORE_SET_RECORDED_WITH_BLOCKERS_AND_DEFERRED_CANDIDATES
