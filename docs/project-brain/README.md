...
>
> Active Development: **P5 — Residual Historical Identity Alternate Upstream Audit 001**
>
...
P5_VALUEIN_CLOSEOUT_MERGED = YES
P5_VALUEIN_CLOSEOUT_MERGE_PR = 57
P5_VALUEIN_CLOSEOUT_MERGE_SHA = b226af16514cb32d2b4f9d3d6e82582f4283183a
P5_RESIDUAL_HISTORICAL_IDENTITY_AUDIT = PASS_ACCESS_DATA_TIER_DECISION_REQUIRED
P5_RESIDUAL_IDENTITY_EPISODE_COUNT = 831
P5_EXISTING_SEC_EDGARTOOLS_RESIDUAL_COVERAGE = 6
P5_RESIDUAL_IDENTITY_UNRESOLVED_COUNT = 825
P5_SHARADAR_IDENTITY_RESULT = ACCESS_BLOCKED_FOR_FULL_831_POC
P5_CRSP_WRDS_IDENTITY_RESULT = ACCESS_BLOCKED_FULL_POC_DOCUMENTED_WHOLE_CAPABILITY_CANDIDATE
P5_OPENFIGI_IDENTITY_RESULT = CORROBORATION_ONLY
P5_SEC_CIK_MAPPER_RESULT = REJECT_CURRENT_ONLY_AND_ARCHIVED
P5_PREFERRED_PRIMARY_INTERVAL_OWNER_FOR_ACCESS_POC = CRSP_US_STOCK_PLUS_COMPUSTAT_SEC_IDHIST
P5_PREFERRED_CIK_BRIDGE_OWNER_FOR_ACCESS_POC = WRDS_SEC_GVKEY_CIK_AND_CIK_CUSIP_LINK_TABLES
P5_AQ_MANUAL_IDENTITY_RULE_COUNT = 0
P5_RESIDUAL_IDENTITY_AUDIT_PRODUCTION_LOC_ADDED = 0
P5_RESIDUAL_IDENTITY_AUDIT_PRIVATE_CHECKSUM_LEDGER_SHA256 = a7d14051c37e634d28f1cf14260db77fb748dadb5e8e8d75fa2544cadd47eb6b
