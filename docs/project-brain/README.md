...
>
> Development Next: **P6 — Macro Feature Observed-at Policy Freeze 001**
>
...
P6_TRUE_UNSOLVED_UPSTREAM_GAP_COUNT = 2
P6_TRUE_UNSOLVED_UPSTREAM_GAPS = NEWS_FIRST_AVAILABLE_AT,SOCIAL_SENTIMENT
P6_RESIDUAL_CUSTOM_CAPABILITY_COUNT = 7
...
P6_CAN_UPSTREAM_OWN_FINAL_MACRO_FEATURE_PANEL = UNRESOLVED_OBSERVED_AT_POLICY_NOT_SELECTED
...
P6_MACRO_FINAL_OBSERVED_AT_FEATURE_POLICY_SELECTED = NO
P6_CUSTOM_ENGINE_REQUIRED = NO
CURRENT_DEVELOPMENT_NEXT = P6_MACRO_FEATURE_OBSERVED_AT_POLICY_FREEZE_001
CURRENT_DEVELOPMENT_NEXT_GATE = UPSTREAM_NATIVE_SESSION_COMPOSITION_POC_PASS
```
