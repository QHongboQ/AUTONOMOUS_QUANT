...
>
> Development Next: **P6 — Macro PIT Session Policy Only Integration 001**
>
...
P6_CAN_UPSTREAM_OWN_MACRO_PIT_PANEL = NO
P6_MACRO_PIT_PANEL_CODE_REQUIRED = YES_PROJECT_SESSION_POLICY_ONLY
P6_CUSTOM_ENGINE_REQUIRED = NO
CURRENT_DEVELOPMENT_NEXT = P6_MACRO_PIT_SESSION_POLICY_ONLY_INTEGRATION_001
CURRENT_DEVELOPMENT_NEXT_GATE = VINTAGE_NATIVE_EVIDENCE_SHAPE_LIVE_POC_PASS
```
