...
>
> Current Next: **P2 — Certification Protocol Preregistration 001**
>
...
P2_CERTIFICATION = STARTED / IN_PROGRESS (CURRENT PROFILE: PERSONAL_CAPITAL_CERTIFICATION)
...
P2_UPSTREAM_CERTIFICATION_STACK_INTEGRATION = COMPLETE_WITH_RECORDED_BLOCKERS
P2_UPSTREAM_CERTIFICATION_STACK_INTEGRATION_CLASSIFICATION = PASS_WITH_RECORDED_BLOCKERS
P2_UPSTREAM_CERTIFICATION_STACK_P2_BLOCKING_BLOCKERS = 2
P2_UPSTREAM_CERTIFICATION_STACK_BLOCKED_COMPONENTS = EXCHANGE_CALENDARS_AND_PANDERA_MISSING_AUTHORIZED_RUNTIME
