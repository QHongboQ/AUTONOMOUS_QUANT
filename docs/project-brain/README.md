...
>
> Current Next: **P2 — Formulaic Alpha Protocol V2 Main Squash Merge 001 (Pending User Authorization)**
>
...
P2_CERTIFICATION_PROTOCOL_V2 = FROZEN_PENDING_MAIN_ACTIVATION
...
P2_FORMULAIC_ALPHA_CURRENT_ELIGIBILITY = ELIGIBLE_PENDING_PROTOCOL_V2_ACTIVATION
P2_FORMULAIC_ALPHA_HISTORICAL_TEST = CONSUMED_AS_RESEARCH_EVIDENCE
P2_FORMULAIC_ALPHA_V2_SEALED_OOS_START = UNRESOLVED_PENDING_MAIN_ACTIVATION
...
CURRENT_NEXT = P2_FORMULAIC_ALPHA_PROTOCOL_V2_MAIN_SQUASH_MERGE_001_PENDING_USER_AUTHORIZATION
