...
>
> Current Next: **P2 — Certified Data Provider Decision**
>
...
P2_CERTIFICATION = STARTED / IN_PROGRESS (OWNS STRICT INSTITUTIONAL CERTIFICATION)
...
QUANTIACS_PILOT_RESULT = FAIL_FREE_ROUTE_COVERAGE
QUANTIACS_CLASSIFICATION = RESEARCH_ONLY_NOT_CERTIFICATION_GRADE
QUANTIACS_PROVIDER_RIGHTS_CONFIRMATION = DEFERRED_UNLESS_ROUTE_RECONSIDERED
