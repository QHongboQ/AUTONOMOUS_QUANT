...
## Factor subprocess Conda path alignment

The second authorized attempt reached loop-0 factor coding but the pinned
`FactorFBWorkspace` launched generated code through its default `python`
setting. The stage PATH therefore selected Miniforge base instead of the
approved `rdagent4qlib` interpreter. Attempt-002 remains immutable at
`D:/AQ_DATA/P3/rdagent-us-ragged/dvc-runs/p3-fin-quant-002`; no model training,
prediction, backtest, or Candidate V2 instance occurred.

The approved environment was repaired separately with the additive binary
wheel `tables==3.10.1`. This task uses RD-Agent's existing
`FACTOR_COSTEER_PYTHON_BIN` setting to bind generated factor execution to the
approved interpreter. No RD-Agent/Qlib source, global PATH, shell profile,
runner, factor engine, or generic environment engine changed. A focused test
executes the pinned upstream `FactorFBWorkspace` boundary and reads the
approved debug HDF through that interpreter.

```text
P3_FAILED_ATTEMPT_002_STATE = PRESERVED_IMMUTABLE_LOOP_0_FACTOR_CODING_EXECUTION_FAILURE
P3_FAILED_ATTEMPT_002_ROOT = D:/AQ_DATA/P3/rdagent-us-ragged/dvc-runs/p3-fin-quant-002
P3_FAILED_ATTEMPT_002_FILES = 526
P3_FAILED_ATTEMPT_002_BYTES = 2056275
P3_FAILED_ATTEMPT_002_REGULAR_CONTENT_MANIFEST_SHA256 = 7c726186ab1aa0f80c494e4de2a4b0eae95f21271611050eb8962bfecdb0a2e7
P3_FAILED_ATTEMPT_002_COMPLETE_ENTRY_MANIFEST_SHA256 = 62aac01dba3e5ac9e47c47148c087637c28fcbca6f78334fa8a5a925fe259123
P3_FAILED_ATTEMPT_002_TRACE_MANIFEST_SHA256 = 29d9f13454d6df2a7e4fce4badb3e33e0295ed4efe35f120d05bb40aa35a2551
...
P3_DVC_DAG = PASS
P3_NEXT_RUN_NAMESPACE = p3-fin-quant-003
